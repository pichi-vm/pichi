...
pub fn midr_to_compatible(midr: u64) -> Option<&'static str> {
...
use dillo_devtree::platform::Arch;

pub fn host_cpu_compatible(arch: Arch) -> Option<&'static str> {
...
mod tests {
    ...
    fn host_compatible_is_none_on_x86() {
        assert_eq!(host_cpu_compatible(Arch::X86_64), None);
    }
}
